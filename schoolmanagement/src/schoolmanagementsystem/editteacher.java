...
public class editteacher extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/sms", "root","mysql123@");
            String sql= "update `teacher` SET `name`='"+tn+"',`spec`='"+spe+"',`subject`='"+sub+"'WHERE id='"+tid+"'";
